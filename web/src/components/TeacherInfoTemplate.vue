          ...
          <div class="col-md-3">
            ...
            >
              ...
              <div style="margin-left: 10px; margin-top: 10px">
                用户名：<span style="color: red">{{
                  $store.state.teacher.username
                }}</span>
              </div>
              <div style="margin-left: 10px; margin-top: 10px">
                手机号：<span style="color: red">{{
                  $store.state.teacher.phone
                }}</span>
              </div>
              <div style="margin-left: 10px; margin-top: 10px">
                教员编号：<span style="color: red">{{
            ...
            >
              ...
              <div class="list-group" style="width: 200px; border-radius: 0%">
                ...
                >
                <router-link
                  to="/teacher/info/password/update/"
                  style="height: 35px"
                  class="list-group-item list-group-item-action"
                  >修改密码</router-link
                >
...
export default {
  ...
  setup() {
    ...
    const handleAvatarChange = (event) => {
      ...
      $.ajax({
        url: "http://127.0.0.1:3000/teacher/account/photo/update/", // 修改为实际的后端接口地址
        type: "post",
        data: formData,
