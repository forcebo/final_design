...
public class JwtUtil {
    ...
    public static String createJWT(String subject, String role) {
        JwtBuilder builder = getJwtBuilder(subject, null, role, getUUID());
        return builder.compact();
    }

    private static JwtBuilder getJwtBuilder(String subject, Long ttlMillis, String role, String uuid) {
